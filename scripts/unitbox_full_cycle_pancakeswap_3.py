...
def main():
    #cross swap
    #UniswapPairV2 niftsy/WETH 0xf3a383ab34f084d6ef9ff375238816fc65153146
    ...
    before_niftsy_treasury = niftsy.balanceOf(treasury)
    before_usdt_treasury = usdt.balanceOf(treasury)
    unitbox.swapMe(niftsy.address, {"from": accounts[1], "gas_price": price})
