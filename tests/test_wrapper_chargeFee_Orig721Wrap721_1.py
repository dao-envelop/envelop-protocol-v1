...
def test_transfer(accounts, erc721mock, wrapper, dai, weth, wnft721, niftsy20, erc1155mock1, erc721mock1, whiteLists, techERC20, wrapperChecker):
    ...
    wrapper.chargeFees(accounts[3], wTokenId, accounts[3], accounts[2], '0x00', {"from": accounts[3]})
    ...
    with reverts("Only for wNFT or wrapper"):
        wrapper.chargeFees(wnft721.address, wTokenId, accounts[3], accounts[2], '0x00', {"from": accounts[3]})
