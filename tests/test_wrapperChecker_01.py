...
def test_wraper_checker(accounts, erc721mock, wrapper, dai, weth, wnft721, niftsy20, wrapperChecker):
	#make test data
	...
	#checks
	assert wrapperChecker.getNativeCollateralBalance(wnft721, wrapper.lastWNFTId(out_type)[1]) == eth_amount
