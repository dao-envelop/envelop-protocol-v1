...
def test_unwrap(accounts, wrapperLight, dai, weth, wnft1155ForWrapperLightV1, erc1155mock1, erc721mock1, mockHacker1155_1):
    ...
    #wrap ERC1155 token. Contract of token change the address @to. Token id 0
    mockHacker1155_1.setFailReciever(accounts[9],0)
    mockHacker1155_1.setWrapper(wrapperLight.address)
    mockHacker1155_1.mint(accounts[1], 0, in_nft_amount, {"from": accounts[1]})
    ...
    hack_data = (hack_property, 0, coll_amount)
