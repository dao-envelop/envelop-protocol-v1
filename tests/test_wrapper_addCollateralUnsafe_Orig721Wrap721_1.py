...
def test_addCollateral(accounts, erc721mock, wrapperTrusted, dai, weth, wnft721, niftsy20, erc1155mock1, erc721mock1, whiteLists, techERC20ForTrustedWrapper):
    ...
    wrapperTrusted.wrap(wNFT, [], accounts[3], {"from": accounts[1], "value": eth_amount})
    ...
    with reverts("WL:Some assets are not enabled for collateral"):
        wrapperTrusted.addCollateral(wnft721.address, wTokenId, [dai_data, weth_data, erc721_data, erc1155_data], {"from": accounts[1]})
    ...
    wrapperTrusted.addCollateralUnsafe(wnft721.address, wTokenId, [dai_data, weth_data, erc721_data, erc1155_data], {"from": accounts[1]})
