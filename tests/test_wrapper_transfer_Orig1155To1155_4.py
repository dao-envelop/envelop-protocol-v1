...
def test_transfer(accounts, erc1155mock, wrapper, dai, weth, wnft1155, niftsy20, niftsy201, whiteLists, techERC20):
    ...
    assert wrapper.getERC20CollateralBalance(wnft1155.address, wTokenId, niftsy20.address) == 2*transfer_fee_amount*royalty[3][1]/techERC20.ROYALTY_PERCENT_BASE()
    assert wrapper.getERC20CollateralBalance(wnft1155.address, wTokenId, niftsy201.address) == 4*transfer_fee_amount*royalty[3][1]/techERC20.ROYALTY_PERCENT_BASE()
