...
def test_transfer(accounts, erc1155mock, wrapper, dai, weth, wnft1155, niftsy20, niftsy201, whiteLists, techERC20, wrapperChecker):
    ...
    wnft1155.safeTransferFrom(accounts[3], accounts[2], wTokenId, 1, "", {"from": accounts[3]})
    ...
    assert wnft1155.balanceOf(accounts[2], wTokenId) == 1
    assert wnft1155.balanceOf(accounts[3], wTokenId) == out_nft_amount - 1
    ...
    wnft1155.safeTransferFrom(accounts[3], accounts[2], wTokenId, out_nft_amount - 1, "", {"from": accounts[3]})
    assert niftsy20.balanceOf(accounts[3]) == 0
    assert niftsy201.balanceOf(accounts[3]) == 0
    assert niftsy20.balanceOf(wrapper.address) == 2*transfer_fee_amount*royalty[3][1]/techERC20.ROYALTY_PERCENT_BASE()
    assert niftsy201.balanceOf(wrapper.address) == 4*transfer_fee_amount*royalty[3][1]/techERC20.ROYALTY_PERCENT_BASE()
    assert niftsy20.balanceOf(accounts[4]) == 2*transfer_fee_amount*royalty[0][1]/techERC20.ROYALTY_PERCENT_BASE()
    assert niftsy201.balanceOf(accounts[4]) == 4*transfer_fee_amount*royalty[0][1]/techERC20.ROYALTY_PERCENT_BASE()
    assert niftsy20.balanceOf(accounts[5]) == 2*transfer_fee_amount*royalty[1][1]/techERC20.ROYALTY_PERCENT_BASE()
    assert niftsy201.balanceOf(accounts[5]) == 4*transfer_fee_amount*royalty[1][1]/techERC20.ROYALTY_PERCENT_BASE()
    assert niftsy20.balanceOf(accounts[6]) == 2*transfer_fee_amount*royalty[2][1]/techERC20.ROYALTY_PERCENT_BASE()
    assert niftsy201.balanceOf(accounts[6]) == 4*transfer_fee_amount*royalty[2][1]/techERC20.ROYALTY_PERCENT_BASE()
    assert wrapperChecker.getERC20CollateralBalance(wnft1155.address, wTokenId, niftsy20.address)[0] == 2*transfer_fee_amount*royalty[3][1]/techERC20.ROYALTY_PERCENT_BASE()
    assert wrapperChecker.getERC20CollateralBalance(wnft1155.address, wTokenId, niftsy201.address)[0] == 4*transfer_fee_amount*royalty[3][1]/techERC20.ROYALTY_PERCENT_BASE()
