...
def test_wrap(accounts, erc721mock, wrapperLight, wnft721ForWrapperLightV1, erc721mock1):
    ...
    wrapperLight.wrap(wNFT, [erc721_data], accounts[3], {"from": accounts[1], "value": eth_amount})    
