...
def test_unwrap(accounts, erc721mock, wrapperTrusted, dai, weth, wnft721, niftsy20, erc1155mock1, erc721mock1):
    ...
    erc721mock.approve(wrapperTrusted.address, ORIGINAL_NFT_IDs[1], {"from": accounts[1]})
    ...
    assert erc721mock.ownerOf(ORIGINAL_NFT_IDs[1]) == wrapperTrusted.address
