...
#one tariff for one service. Switch off service like agent. Try to wrap
def test_settings(accounts, erc721mock, wrapperTrustedV1, dai, weth, wnft721, niftsy20, saftV1, whiteListsForTrustedWrapper, techERC20ForSaftV1, subscriptionManager):
    ...
    #switch off service like agent
    subscriptionManager.setAgentStatus(saftV1, False, {"from": accounts[0]}) 
