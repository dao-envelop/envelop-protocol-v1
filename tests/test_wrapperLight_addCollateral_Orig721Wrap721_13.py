...
def test_addCollateral(accounts, erc721mock, wrapperLight, dai, weth, wnft721ForWrapperLightV1, niftsy20, erc721mock1):
    ...
    #add collaterall
    tx = wrapperLight.addCollateral(wnft721ForWrapperLightV1.address, wTokenId, [erc721_data], {"from": accounts[1], "value": eth_amount})
