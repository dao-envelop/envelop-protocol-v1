...
def test_transfer(accounts, erc1155mock, wrapper, dai, weth, wnft1155, niftsy20, erc1155mock1, whiteLists, techERC20, wrapperChecker):
    ...
    whiteLists.setWLItem((4, wnft1155.address), wl_data, {"from": accounts[0]})
    ...
    logging.info(erc1155mock.balanceOf(accounts[3], ORIGINAL_NFT_IDs[1]))    
    ...
    wrapper.addCollateral(wnft1155.address, wTokenId - 1, [((out_type, wnft1155.address), wTokenId, out_nft_amount)], {"from": accounts[3]})
