...
def test_unwrap(accounts, erc721mock, wrapper, dai, weth, wnft721, niftsy20, erc1155mock1, erc721mock1):
    ...
    niftsy20.approve(wrapper.address, 3*call_amount, {'from':accounts[1]})
    wrapper.wrap(wNFT, [ dai_data, weth_data, erc721_data, erc1155_data, niftsy20_data], accounts[3], {"from": accounts[1], "value": eth_amount})
