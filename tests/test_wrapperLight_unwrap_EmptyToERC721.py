...
def test_unwrap(accounts, erc1155mock, wrapperLight, dai, weth, wnft721ForWrapperLightV1, niftsy20, erc1155mock1, erc721mock1):
    ...
    with reverts("TimeLock error"):
        wrapperLight.unWrap(out_type, wnft721ForWrapperLightV1.address, wTokenId, {"from": accounts[3]} )
    ...
    assert wnft721ForWrapperLightV1.balanceOf(accounts[3]) == 0
